...
class CabServiceProvider{
    ...
    {
        if(this.cabServiceName=="Halo" && (driver.getAverageRating()>=4.5 && driver.getAverageRating()<=5))
        {
            return driver.getAverageRating()*10;
        }
        else if(this.cabServiceName=="Halo" &&(driver.getAverageRating()>=4 && driver.getAverageRating()<4.5))
        {
            return driver.getAverageRating()*5;
        }
          else if(this.cabServiceName=="Aber" &&(driver.getAverageRating()>=4.5 && driver.getAverageRating()<=5))
        {
            return driver.getAverageRating()*8;
        }
          else if(this.cabServiceName=="Aber" &&(driver.getAverageRating()>=4 && driver.getAverageRating()<4.5))
        {
